...
public class CustomRestTemplate extends RestTemplate {
	...
	public <T> ResponseEntity<LinkedMultiValueMap> execute(Message message) throws ApiException {
		...
		UriComponents uriComponents = UriComponentsBuilder.fromHttpUrl(message.getUrl())/*
																						 * .queryParams(message.
																						 * getHeaderMap())
																						 */.build();
		...
		try {
			...
			response = super.exchange(uriComponents.toString(), HttpMethod.valueOf(message.getHttpMethod()), entity,
