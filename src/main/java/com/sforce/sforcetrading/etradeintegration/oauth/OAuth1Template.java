...
public class OAuth1Template {
    ...
    /*
     * The timestamp value MUST be a positive integer and MUST be equal or greater
     * than the timestamp used in previous requests
     */
    ...
    /**
     * Mehtod to generate the oauth signature string. oauth_signature, string made
     * up of several HTTP request elements in a single string.
     * 
     ...
     */
    public void computeOauthSignature(String method, String uri, String querySring)
    ...
    private String getNormalizedParams(Map<String, String[]> paramMap) {
        ...
        // now we generate a string for the map in key=value&key1=value1 format by
     ...
     * oauth_signature and oauth_signature_method parameters and their values.
     * 
    ...
    /**
     * It is a single string and separated generally by a comma and named
     * Authorization.
     * 
    ...
    public String getAuthorizationHeader() {
        ...
        log.debug(" getAuthorizationHeader : " + context.isIntialized() + " isOauthRequired "
                + message.getOauthRequired());
        if (context.isIntialized() || OauthRequired.YES == message.getOauthRequired()) {
     ...
     *              Format : OAuth
     *              realm="",oauth_signature="y%2Fkoia4FeOmALwM9Zl94pAKxjiw%3D",oauth_nonce="MTE2OTUzMzA0NDM4MDg2NzQwMw%3D%3D",
    ...
    /**
     * @return OAuthSigner - Returns HMAC-SHA1 implementation based on the property
     *         defined under oauth property file
     */
